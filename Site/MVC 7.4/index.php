  ...
  <body>
    <header>
      <nav class="navbar">
        ...
        <a href="login.php"
          ><img id="icon-entrar" src="View/assets/img/login.png"
        /></a>

        <a class="buttons-lc" href="View/login.php"
          ><button id="nav-entrar">LOGIN</button></a
        >
        <a class="buttons-lc" href="View/cadastro.php"
          ><button id="nav-cadastro">CADASTRO</button></a
        >
      </nav>
    </header>
    <div id="back1">
