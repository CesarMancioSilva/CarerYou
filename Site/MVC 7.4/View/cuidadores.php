...
<body>
    ...
    <div class="all-content">
        <div class="filtro-div">
            ...
            <div class="filtro-card">
                ...
                <div class="filtro-categoria">
                    ...
                    <div class="conjunto-input">
                        <div class="input-div">
                            <input name="Gênero" id="Feminino" type="radio"><label for="Feminino">Feminino</label>
                        </div>
                        <div class="input-div">
                            <input name="Gênero" id="Masculino" type="radio"><label for="Masculino">Masculino</label>
                        </div>
                    </div>
                </div>
        ...
        <div class="cards-div">
            ...
            //$res = false;
            if ($res === []) {
                echo "Não existem profissionais dentro do sistema...";
            } else {
