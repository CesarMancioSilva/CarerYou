...
<body>
        ...
        <div id="back1">
            ...
            <div id="txt1">
                ...
                <div class="txt" id="a1">
                    <img id="background4"src="assets/img/background4.png" >
                    <h1>ENCONTRE O PROFISSIONAL<br> IDEAL PARA SUA FAMILIA</h1><br>
                    <div id="subtitulo1"><p>Localize cuidadores, casas de repouso e asilos mais perto de você e sua familia</p></div>
                    <br>
        ...
        <div id="back2">
            <div id="esquerda1">
               <img class="cuidadora2" id="cd2"src="assets/img/cuidadora2.png" >
               <img class="cuidadora2" id="cd3"src="assets/img/cuidadora3.png" >
               <img class="cuidadora2" id="cd4"src="assets/img/cuidadora4.png" >
               <img class="cuidadora2" id="cd5"src="assets/img/cuidadora5.png" >
                
            </div>
            <div class="txt"id="direita1">
                <ul>
                    <li><h1>CUIDADORES</h1><br></li>
                    <li><div id="subtitulos-back"><p>Localize cuidadores, casas de repouso e asilos mais perto de você e sua familia. Localize cuidadores, casas de repouso e asilos mais perto de você e sua familia</p></div></li>
                    <br>
        ...
        <div id="back3">
            <div class="txt"id="esquerda2">
                <ul>
                    <li><h1>ASILOS E CASAS DE REPOUSO</h1><br></li>
                    <li><div id="subtitulos-back"><p>Localize cuidadores, casas de repouso e asilos mais perto de você e sua familia. Localize cuidadores, casas de repouso e asilos mais perto de você e sua familia</p></div></li>
                    <br>
                    <li> <button>SAIBA MAIS</button></li>
                </ul>
